...
public class ItemHeart implements IItemRenderer{

	TileEntitySpecialRenderer render;
	private TileEntity entity;
	
	public ItemHeart(TileEntitySpecialRenderer render, TileEntity entity){
		this.entity = entity;
		this.render = render;
	}
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		...
		case EQUIPPED_FIRST_PERSON:
			GL11.glTranslatef(0.15F, 0.8F, 1.3F);
		...
		case ENTITY:
			...
			break;
		case INVENTORY:
			GL11.glTranslatef(2F, 1.7F, 1.9F);
