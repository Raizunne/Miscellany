...
public class bookResources {
	...
	public static final String chalice2 = "Whenever the wielder wants to place some water from the chalice, the user should drop a gigantic 1 meter pebble inside of the chalice.";
